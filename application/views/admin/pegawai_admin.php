				...
				<div class="col-md-12">
					<div class="card">
						<div class="card-header">
							<a href="<?php echo site_url('admin/Pegawai/add_peg_admin');?>">
									...
									<tbody>
										...
										foreach ($pegawai as $peg) 
										{
											...
											<tr>
												...
												<td><a href="<?php echo site_url('admin/pegawai/edit_peg_admin/'.$peg->no_peg);?>"><i class="la la-edit" style="font-size:20px"></i></a></td>
												<td><a id="hasil" href="<?php echo site_url('admin/pegawai/delete_peg_admin/'.$peg->no_peg);?>"><i class="la la-remove" style="font-size: 20px"></i></a></td>
