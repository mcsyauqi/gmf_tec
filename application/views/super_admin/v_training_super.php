				...
				<div class="col-md-12" style="max-width: 100%; width: auto;">
					<div class="card">
						<div class="card-header">
							<a id="non_print" href="<?php echo site_url('super_admin/pegawai_super/lap_peg_excel');?>">
												...
												<tr>
													...
													<?php if ($done_bener!=0000-00-00) { ?>
														...
														<?php } 
															...
															echo date("d-M-Y",$done_bener);?></span></td> <?php
															mysqli_query($connect,"UPDATE training set stat_human=0 where no_peg='$train->no_peg' ");
															?>
														<?php } ?>
													...
													<?php if ($done_bener!=0000-00-00) { ?>
														...
														<?php } 
															...
															echo date("d-M-Y",$done_bener);?></span></td> <?php
															mysqli_query($connect,"UPDATE training set stat_cas=0 where no_peg='$train->no_peg' "); ?>
